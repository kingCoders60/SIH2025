...
import { mockAlerts, emergencyContacts, alertFilters, contactFilters } from "../data/alertsData"
import { AlertTriangle, Phone, Search, Filter, Bell, Users } from "lucide-react"
...
const Alerts = () => {
  ...
  const highPriorityContacts = emergencyContacts.filter((contact) => contact.priority === "high").length

  const tabs = [
    { id: "alerts", label: "Emergency Alerts", icon: AlertTriangle, count: alerts.length },
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Stay informed with real-time alerts and emergency contact information</p>
        </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{highPriorityContacts}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm border mb-6">
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder={`Search ${activeTab === "alerts" ? "alerts" : "contacts"}...`}
                value={searchTerm}
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                onChange={(e) =>
                  activeTab === "alerts" ? setAlertFilter(e.target.value) : setContactFilter(e.target.value)
                }
                className="border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
                {(activeTab === "alerts" ? alertFilters : contactFilters).map((filter) => (
          ...
          <div className="space-y-4">
            {filteredAlerts.length > 0 ? (
              filteredAlerts
                ...
                .map((alert) => <AlertCard key={alert.id} alert={alert} onDismiss={handleDismissAlert} />)
            ) : (
