...
import { badges, leaderboardData, calculateLevel, getXPToNextLevel } from "../data/gamificationData"
...
const Gamification = () => {
  ...
  const userProgress = {
    ...
    drillsCompleted: 2,
    dailyStreak: 5,
    earnedBadges: ["first_module", "drill_participant"],
    recentGain: 100,
  }
  ...
  const stats = [
    { label: "Total XP", value: userProgress.xp.toLocaleString(), icon: Star, color: "blue" },
    { label: "Current Level", value: level, icon: Trophy, color: "yellow" },
    { label: "Badges Earned", value: userProgress.earnedBadges.length, icon: Award, color: "purple" },
    { label: "Global Rank", value: "#47", icon: Target, color: "green" },
  ]
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {activeTab === "overview" && (
          <div className="space-y-8">
                ...
                return (
                  <div key={index} className="bg-white rounded-lg p-6 shadow-sm border">
                    <div className="flex items-center space-x-3">
                      <div className={`p-3 rounded-lg bg-gradient-to-r ${colorClasses[stat.color]} text-white`}>
            ...
            <XPBar
              ...
              recentGain={userProgress.recentGain}
            />
        ...
        {activeTab === "leaderboard" && (
          <div className="space-y-6">
            <Leaderboard users={leaderboardData} currentUserId={user?.id} />
          </div>
        )}
        ...
        {activeTab === "achievements" && (
          <div className="bg-white rounded-lg p-6 shadow-sm border">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">Achievement tracking will be available in the next update.</p>
            </div>
          </div>
        )}

        {/* Achievement Toast */}
        {showAchievement && <AchievementToast achievement={showAchievement} onClose={() => setShowAchievement(null)} />}
      </div>
    </div>
  )
}
